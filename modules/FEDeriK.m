...
NonCommutativeMultiply/:FTerm[pre___,NonCommutativeMultiply[in___],post___]:=FTerm[pre,in,post]
...
QMeSForm[setup_,expr_]:=Map[QMeSNaming[setup,#]&,expr,{1,3}]//.{FEx:>List,FTerm:>Times};
...
FEx[
FTerm[-1, Phidot[{AnyField},{a}], GammaN[{AnyField},{-a}]],
...
(* ::Input::Initialization:: *)
MakeDSE[setup_,field_]:=Module[{classAct,dS},
AssertFSetup[setup];
