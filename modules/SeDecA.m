...
If[MemberQ[Join[setup["FieldSpace"]["Commuting"],setup["FieldSpace"]["Grassmann"]],name[__],Infinity],Message[SeDecA::FieldExists,name];Abort[]];
...
If[MemberQ[Join[setup["FieldSpace"]["Commuting"],setup["FieldSpace"]["Grassmann"]],name1[__]|name2[__],Infinity],Message[SeDecA::FieldExists,{name1,name2}];Abort[]];
