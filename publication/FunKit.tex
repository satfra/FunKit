...
\begin{mmaCell}{Input}
\mmaDef{TakeDerivatives}[\mmaDef{setup}, \mmaDef{wEq}, \{A[i1], A[i2]\}]//\mmaDef{FTruncate}//\mmaDef{FPrint}//\mmaDef{FPlot};
\end{mmaCell}
\vspace{-3.5ex}
\begin{equation*}
...
\put(-215,-90){\includegraphics[width=1.02\linewidth]{Mathematica_Gluon2P_4.png}}
\end{equation*}
\end{minipage}
\end{widetext}
%
