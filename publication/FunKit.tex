...
\end{mmaCell}
%
which yields precisely the same output as when using \mathem{\mmaDef{FTakeDerivatives}} or \mathem{\mmaDef{FResolveDerivatives}}, both of which invoke the simplification step automatically.
